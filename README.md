...
# 2. Работа с кодом программы.
   ...
   нужно ввести токен, который прислал BotFather.  
    2. В папке проекта нужно создать следующие папки: папку с названием ``dataset``, она будет служить базой данных изображений лиц пользователя, папку с названием ``video``, в неё будут сохраняться записанные видео и видео, присланные пользователями, папку с названием ``image``, в нее будут сохраняться сделанные фото. 
