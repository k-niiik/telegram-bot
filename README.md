...
# 2. Работа с кодом программы.
   ...
   нужно ввести токен, который прислал BotFather.  
     ...
     -   Файл с названием ``admin_password``, в него нужно записать пароль администратора <br>
     -   Файл с названием ``admins``, в него будут сохраняться Telegram ID администраторов <br>
     -   Файл с названием ``user_password``, в него нужно записать пароль обычных пользователей <br>
